<nav class="p-4 flex flex-col justify-between h-full overflow-y-auto">
    <div>
        @php
    ...
    <div class="flex flex-col gap-2 mt-4">
        <a href="{{ route('documentation') }}" class="bg-black text-white px-3 py-2 text-xs uppercase hover:bg-white hover:text-black border border-black">
            API
        </a>

        <a href="{{ route('contact') }}" class="bg-black text-white px-3 py-2 text-xs uppercase hover:bg-white hover:text-black border border-black">
            CONTACT
        </a>
    </div>
</nav>